...
function PixelGrid() {
  ...
  var mousePos = Object(_hooks_getMousePosition__WEBPACK_IMPORTED_MODULE_3__["default"])(canvas);
  return __jsx("div", {
    className: "centered",
    __source: {
    ...
    __self: this
  }, "Mouse was last seen at gridpoint: (,)"), __jsx("canvas", {
    className: "pixelGrid",
    id: "pixelGrid",
    width: canvasDim.x,
    height: canvasDim.y,
...
//# sourceMappingURL=index.js.c2bf3b56b3dc5af28eae.hot-update.js.map