...
function PixelGrid() {
  ...
  var gridPoints = convertPositionToGrid(mousePos, 4);
  return __jsx("div", {
    className: "centered",
    __source: {
    ...
    __self: this
  }, "Last active gridpoint based on position: (,)"), __jsx("canvas", {
    className: "pixelGrid",
    id: "pixelGrid",
    width: canvasDim.x,
    height: canvasDim.y,
...
function convertPositionToGrid(pos, size) {
  return {
    x: convert(pos.x, size),
    y: convert(pos.y, size)
  };
}
...
//# sourceMappingURL=index.js.1e78a4b8257b030ffc09.hot-update.js.map